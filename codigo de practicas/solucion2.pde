...
/*  Teniendo claro como funciona el sistema de coordenadas, debemos usar la función line( x1, y1, x2, y2);
    ...
    trazaras una linea entre esos dos puntos, diríamos entonces que ( x1, y1 ) bienen siendo las 
    coordenadas de tu casa y ( x2, y2) bienen siendo las coordenadas de la casa de tu amigo.
