//  código tomado de http://www.openprocessing.org/sketch/86293
class Linea
{
  float changement;
  float ah1;
  ...
  void dibujarLinea()
  {
    ...
    int espch = 20;
    int espcv = 50;
    int phd = (width-espch*20)/2;
    int pvd = (height-espcv*4)/2;;
    int epsl= 5;
    int epse = epsl*2;
    int vite = 1;

    if (cah1<1) cah1 = phd+espch*0-espch;
    ...
    if (cah1 > phd+ah1*espch) cah1 = width*3;
