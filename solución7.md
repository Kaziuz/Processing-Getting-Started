// para cambiar el color del borde de cualquier figura en processing, no solo un circulo; usamos la función stroke(); precedida de una función de dibujo como rect(); o ellipse();
